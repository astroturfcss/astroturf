...
- **extension**: (default: `'.css'`) the extension used for extracted style files. `extension` generally informs the
...
- **experiments**: Opt in to any experimental features we are testing out.
  ...
  - **experiments.selfCompile**: Skip the additional css-module setup and let astroturf
